...
export default function Campo() {
  ...
  function calcularVencedor() {
    if (quadrados[0] == 'X' && quadrados[1] == "X" && quadrados[2] == "X") {
      console.log('ganhou');
    } else if (quadrados[3] == 'X' && quadrados[4] == "X" && quadrados[5] == "X") {
      console.log('ganhou');
    } else if (quadrados[6] == 'X' && quadrados[7] == "X" && quadrados[8] == "X") {
      console.log('ganhou');
    } else if (quadrados[0] == 'X' && quadrados[3] == "X" && quadrados[6] == "X") {
      console.log('ganhou');
    } else if (quadrados[1] == 'X' && quadrados[4] == "X" && quadrados[7] == "X") {
      console.log('ganhou');
    } else if (quadrados[2] == 'X' && quadrados[5] == "X" && quadrados[8] == "X") {
      console.log('ganhou');
    } else if (quadrados[0] == 'X' && quadrados[4] == "X" && quadrados[8] == "X") {
      console.log('ganhou');
